...
$onlyif[$getuservar[учёный_выбор]==вакцина;{newEmbed:{thumbnail:https://cdn.discordapp.com/emojis/606562703917449226.gif?v=1&size=4096}{title:Произошла ошибка!}{description:Вы должны были выбрать $replacetext[$replacetext[$replacetext[$getuservar[учёный_выбор];вакцина;⚗️];расчёт;📊];вирус;🦠]}{color:$getvar[color_error]}}{ephemeral}{interaction}]

$onlyif[$getuservar[учёный_выбор]!=;{"embeds": "{newEmbed:{thumbnail:https://cdn.discordapp.com/emojis/606562703917449226.gif?v=1&size=4096}{title:Произошла ошибка!}{description:На данный момент для вас нет работы!}{color:$getvar[color_error]}}{ephemeral}{interaction}]
...
$onlyIf[$advancedTextSplit[$interactionData[customId];_;1]==вакцина;] 
`
})
