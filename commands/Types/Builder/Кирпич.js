...
type: "interaction",
prototype: "button",
code: `$interactionReply[;{newEmbed:{author:$usertag | 🧱:$useravatar}{description:Вы **построили новую стену для будущего штаба Яндекса** и получили $random[2000;4000]$getvar[wallet] и $random[15;35]xp}{color:$getvar[color]}}] 
$setuservar[build_выбор;]
$setuservar[korm;$sum[$getuservar[korm];$random[2000;4000]]]
$setuservar[xp;$sum[$getuservar[xp];$random[15;35]]] 
$onlyif[$getuservar[build_выбор]==кирпич;{"embeds": "{newEmbed:{thumbnail:https://cdn.discordapp.com/emojis/606562703917449226.gif?v=1&size=4096}{title: Произошла ошибка!}{description:}{color:RED}}", "ephemeral" : true, "options" : { "interaction" : true}}]
...
$onlyIf[$advancedTextSplit[$interactionData[customId];_;1]==кирпич;] 
`
})
