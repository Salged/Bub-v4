...
$interactionReply[{newEmbed:{title:Пополнение баланса}{description:$usertag выдал пользователю <@$interactiondata[options.data[0].value]> $interactiondata[options.data[1].value]$getvar[wallet]}{color:$getvar[color]}}]
