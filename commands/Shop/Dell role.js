...
$interactionReply[{newEmbed:{title: Удаление роли из магазина}{description:Вы удалили роль <@&$getservervar[роль_$get[role]]>, её цена была $getservervar[цена_$get[role]]$getvar[wallet]}{color:$getvar[color]}}]
