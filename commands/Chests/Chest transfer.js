...
$interactionReply[Вы передали <@$interactionData[options.data[0].options[0].value]> \`$replacetext[$replacetext[$replacetext[$interactionData[options.data[0].options[1].value];1;Обычный];2;Редкий];3;Эпический]\` сундук $customemoji[q_chest_$interactionData[options.data[0].options[1].value]]
...
$onlyif[$getuservar[chest_$interactionData[options.data[0].options[1].value]]>=1;{newEmbed:{thumbnail:https://cdn.discordapp.com/emojis/606562703917449226.gif?v=1&size=4096}{title: Произошла ошибка!}{description:У вас нет сундуков данного типа}{color:$getvar[color_error]}}{ephemeral}{interaction}]

$onlyif[$memberexists[$interactionData[options.data[0].options[0].value]]==true;{newEmbed:{thumbnail:https://cdn.discordapp.com/emojis/606562703917449226.gif?v=1&size=4096}{title: Произошла ошибка!}{description: Пользователя нет на сервере}{color:$getvar[color_error]}}{ephemeral}{interaction}]
