...
$interactionReply[Вы открыли \`$replacetext[$replacetext[$replacetext[$interactionData[options.data[0].options[0].value];1;Обычный];2;Редкий];3;Эпический]\` сундук, и вам выпало $multi[$interactionData[options.data[0].options[0].value];$random[2000;4000]]$getservervar[wallet]]
