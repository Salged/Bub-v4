...
$setuservar[build_выбор;$randomText[добыть;взорвать;очистить]]
$interactionReply[;{newEmbed:{author:Работа на строй площадке:$useravatar}{field:Ваша задача#COLON# **$replaceText[$replaceText[$replaceText[$randomText[кирпич;техника;покурить];кирпич;класть кирпич];техника;занести технику];покурить;пойти покурить]**:\n🧱 — класть кирпичи\n💻 — занести технику\n🚬 — пойти покурить}{color:$getvar[color]}};{actionRow:{button:🧱:2:кирпич_$authorid}{button:🖥️:2:техника_$authorid}{button:🚬:2:о
покурить_$authorid}}{actionRow:{button: Напомнить:1:buildremind_$authorid}}]
