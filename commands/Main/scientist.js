...
$interactionReply[;{newEmbed:{author:Работа на строй площадке:$useravatar}{field:Ваша задача#COLON# **$replaceText[$replaceText[$replaceText[$randomText[вирус;вакцина;расчёт];вирус;изучить вирус];вакцина;изобрести вакцину];расчёт;делать расчёты]**\n🦠 - изучить вирус\n⚗️ - изобрести вакцину\n📊 - делать расчёты}{color:$getvar[color]}};{actionRow:{button:🦠:2:вирус_$authorid}{button:⚗️:2:вакцина_$authorid}{button:📊:2:расчёт_$authorid}}{actionRow:{button: Напомнить:1:учёныйremind_$authorid}}]
