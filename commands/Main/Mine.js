...
$let[выбор;$randomText[⛏️ добыть;🧨 взорвать;🏺 очистить]]
$interactionReply[;{newEmbed:{author:Работа в глубокой шахте:$useravatar}{description:Ваша задача: **$randomText[⛏️ добыть;🧨 взорвать;🏺 очистить]**\{color:$getvar[color]}};{actionRow:{button:⛏️:2:добыть_$authorid}{button:🧨:2:взорвать_$authorid}{button:🏺:2:очистить_$authorid}}{actionRow:{button: Напомнить:1:mineremind_$authorid}
