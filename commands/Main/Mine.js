...
$interactionReply[;{newEmbed:{author:Работа в глубокой шахте:$useravatar}{field:Ваша задача#COLON# **$randomText[добыть;взорвать;очистить]**:⛏️ — добыть \n🧨 — взорвать \n#COLON#rock#COLON# — очистить}{color:$getvar[color]}};{actionRow:{button:⛏️:2:добыть_$authorid}{button:🧨:2:взорвать_$authorid}{button:$nonescape[:rock:]:2:очистить_$authorid}}{actionRow:{button: Напомнить:1:mineremind_$authorid}}]
