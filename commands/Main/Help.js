...
$interactionReply[{newEmbed:{author:Команды Буба:$userAvatar[$clientid]}{field:Администраторам:\`add_role, delete_role, upcoin, uncoin\`}{field:Основные:\`bub, bot, bank, chest, casino, skins, wardrobe\`}{field:Заработок:\`mine, builder, bonus\`}{field:Разное:\`walk, leaderboard, name, pay, buy_role, store, rob\`}{color:$getvar[color]}}]
