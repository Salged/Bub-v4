...
},
{
    ...
    code: `
        ...
        $let[skinData;$djsEval[JSON.stringify(require("../handler/skins-data.js")[data.get("skin")])]]
        $let[skinImage;$djsEval[JSON.parse(data.get("skinData")).image]]
        $let[skinPrice;$djsEval[JSON.parse(data.get("skinData")).price]]
        $let[skinName;$djsEval[JSON.parse(data.get("skinData")).name]]
