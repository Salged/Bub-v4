...
🌈 ・ $replacetext[$replacetext[$getservervar[lang];ru;Настроение];en;Mood]: **$replaceText[$replaceText[$checkCondition[$getUserVar[md;$get[id]]<150];true;$replacetext[$replacetext[$getservervar[lang];ru;Плохое];en;bad]];false;$replacetext[$replacetext[$getservervar[lang];ru;Хорошее];en;good]]** ($getuservar[md]/150)
